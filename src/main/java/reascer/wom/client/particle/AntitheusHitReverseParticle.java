...
@OnlyIn(Dist.CLIENT)
public class AntitheusHitReverseParticle extends NoRenderParticle {
	public AntitheusHitReverseParticle(ClientLevel world, double x, double y, double z, double width, double height, double _null) {
		super(world, x, y, z);
		...
		this.level.addParticle(WOMParticles.ANTITHEUS_CUT.get(), this.x, this.y, this.z, 180.0D, 0.0D, 0.0D);
		double d = 0.2F;
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			AntitheusHitReverseParticle particle = new AntitheusHitReverseParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
			return particle;
		}
	}
}