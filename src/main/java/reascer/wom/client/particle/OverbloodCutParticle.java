...
@OnlyIn(Dist.CLIENT)
public class OverbloodCutParticle extends HitParticle {
	public OverbloodCutParticle(ClientLevel world, double x, double y, double z, SpriteSet animatedSprite) {
