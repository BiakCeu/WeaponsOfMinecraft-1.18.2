...
@OnlyIn(Dist.CLIENT)
public class EnderblasterbulletParticle extends HitParticle {
	public EnderblasterbulletParticle(ClientLevel world, double x, double y, double z, SpriteSet animatedSprite) {
