...
public class AntitheusHitParticle extends NoRenderParticle {
	public AntitheusHitParticle(ClientLevel world, double x, double y, double z, double width, double height, double _null) {
		super(world, x, y, z);
		...
		this.level.addParticle(EFEpicFightParticles.ANTITHEUS_CUT.get(), this.x, this.y, this.z, 0.0D, 0.0D, 0.0D);
		double d = 0.2F;
