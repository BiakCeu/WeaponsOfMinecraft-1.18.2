...
@OnlyIn(Dist.CLIENT)
public class OverbloodHitParticle extends NoRenderParticle {
	public OverbloodHitParticle(ClientLevel world, double x, double y, double z, double width, double height, double _null) {
		super(world, x, y, z);
		...
		this.level.addParticle(EFEpicFightParticles.OVERBLOOD_CUT.get(), this.x, this.y, this.z, 0.0D, 0.0D, 0.0D);
		double d = 0.2F;
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			OverbloodHitParticle particle = new OverbloodHitParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
			return particle;
		}
	}
}