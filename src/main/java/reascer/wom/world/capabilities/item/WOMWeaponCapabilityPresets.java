...
public class WOMWeaponCapabilityPresets {
	...
	public static final Function<Item, CapabilityItem.Builder> ANTITHEUS = (item) -> {
		CapabilityItem.Builder builder = WeaponCapability.builder()
				...
				.livingMotionModifier(Styles.TWO_HAND, LivingMotions.NONE, WOMAnimations.ANTITHEUS_IDLE)
				...
				.livingMotionModifier(Styles.OCHS, LivingMotions.NONE, WOMAnimations.ANTITHEUS_ASCENDED_IDLE)
