...
public class EFColliders {
	...
	public static final Collider RUINE_COMET = new MultiOBBCollider(4, 0.8D, 0.8D, 1.75D, 0D, 0D, -1.3D);
	
	public static final Collider TORMENT = new MultiOBBCollider(3, 0.4F, 0.6F, 1.0F, 0F, -0.2F, -0.8F);
	public static final Collider TORMENT_AIRSLAM = new OBBCollider( 1.2F, 0.8F, 1.2F, 0F, 0.8F, -1.6F);
	...
	public static final Collider ENDER_DASH = new MultiOBBCollider(4, 1.2D, 1.2D, 1.2D, 0D, 1.2D, 0.0D);
