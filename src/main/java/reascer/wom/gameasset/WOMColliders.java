...
public class WOMColliders {
	...
	public static final Collider ANTITHEUS = new MultiOBBCollider(3, 0.4F, 1.2F, 0.8F, 0F, -0.2F, -1.6F);
	public static final Collider ANTITHEUS_AGRESSION = new MultiOBBCollider(3, 0.4F, 1.0F, 1.6F, 0F, -0.4F, -0.9F);
	public static final Collider ANTITHEUS_AGRESSION_REAP = new OBBCollider(0.5F, 0.5F, 3.0F, 0F, 0.5F, -1.75F);
	...
	public static final Collider ANTITHEUS_SHOOT = new MultiOBBCollider(4, 0.3D, 1.6D, 0.3D, 0.0D, -1.7D, 0.0D);
